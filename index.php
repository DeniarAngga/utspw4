...
<head>
	<meta charset="utf-8">
	<title>APLIKASI PEREKAMAN DATA LAPTOP </title>
	<link rel="stylesheet" type="text/css" href="bootstrap/css/bootstrap.min.css">
</head>
<body>
<div class="container">
	<h1 class="page-header text-center">APLIKASI PEREKAMAN DATA LAPTOP</h1>
	<h2 class="page-header text-center">DI DEN-SKY JAYA</h2>
	<div class="row">
